...
for f in setup_complete.sql 002_ui_tables.sql 004_call_failure_type.sql 006_org_id_canonical_cutover.sql 007_call_end_reason_normal_completion.sql 008_call_semantics_backfill.sql 009_calendar_backbone.sql; do
